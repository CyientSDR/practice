...
PREPARE_LOGGING(practice_i)

practice_i::practice_i(const char *uuid, const char *label) :
    practice_base(uuid, label)
{
    // Avoid placing constructor code here. Instead, use the "constructor" function.

}

practice_i::~practice_i()
{
}

void practice_i::constructor()
{
    /***********************************************************************************
...
/***********************************************************************************************
    ...
    Messages:
        ...
        void practice_i::my_message_callback(const std::string& id, const my_msg_struct &msg){
        }
        
        Register the message callback onto the input port with the following form:
        this->msg_input->registerMessage("my_msg", this, &practice_i::my_message_callback);
    ...
    Properties:
        ...
        addPropertyListener(<property>, this, &practice_i::<callback method>)
        in the constructor.
        ...
        practice_i::practice_i(const char *uuid, const char *label) :
            practice_base(uuid, label)
        {
            addPropertyListener(scaleValue, this, &practice_i::scaleChanged);
            addPropertyListener(status, this, &practice_i::statusChanged);
        }

        void practice_i::scaleChanged(float oldValue, float newValue)
        {
            RH_DEBUG(this->_baseLog, "scaleValue changed from" << oldValue << " to " << newValue);
        }
            
        void practice_i::statusChanged(const status_struct& oldValue, const status_struct& newValue)
        {
...
************************************************************************************************/
int practice_i::serviceFunction()
{
